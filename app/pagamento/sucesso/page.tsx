...
export const metadata: Metadata = {
  title: 'Pagamento Aprovado - Instituto Fenix',
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Obrigado pela sua doação! Seu pagamento foi processado com sucesso.
            </p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Verifique sua caixa de entrada (e spam) para o comprovante de doação.
                  </p>
                </div>
              </div>
            </div>
